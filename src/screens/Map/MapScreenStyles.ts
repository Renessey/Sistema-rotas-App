...
export const createScreenStyles = (colors: any) => {
  ...
  return StyleSheet.create({
    ...
    floatingStartBtn: {
      ...
      alignItems: 'center',
      justifyContent: 'center',
      backgroundColor: '#059669', // Emerald Green / Vibrant Start Button
      paddingVertical: 13,
      paddingHorizontal: spacing.md,
      borderRadius: radius.full,
      gap: 6,
    ...
    sheetStartBtn: {
      ...
      paddingHorizontal: spacing.md,
      borderRadius: radius.md,
      backgroundColor: isDark ? 'rgba(16, 185, 129, 0.3)' : '#059669',
      borderWidth: isDark ? 1.5 : 1,
    ...
    sheetFinishBtn: {
      ...
      paddingHorizontal: spacing.md,
      borderRadius: radius.md,
      backgroundColor: isDark ? 'rgba(100, 116, 139, 0.22)' : '#475569',
      borderWidth: isDark ? 1.5 : 1,
